        ...
        <section className="About py-20 backdrop-blur-sm">
            <div className="container px-10 mx-auto flex md:flex-row flex-col-reverse  ">
                <div className="flex-1 text-center md:text-left">
                    ...
                    <h6 className="text-xl py-6">
                        Learn more at{" "}
                        <Link
                            target="_blank"
                            href="www.shadeemerhi.com"
                            className="relative before:bg-under_g before:absolute before:h-1 inline-block  before:-inset-1 before:top-8 before:rounded"
                        >
                            shadeemerhi.com
                        </Link>{" "}
                    </h6>
                ...
                <div className=" flex items-center flex-col flex-1 pb-5">
                    <Image
                        ...
                        height="300"
                    />
                    <div className="max-w-sm flex flex-wrap gap-5 justify-center mt-10 ">
                        {" "}
                        <Link
                            href="#"
                            className="flex items-center justify-center gap-3 py-2 px-6 rounded-md border border-zinc-600 w-[161px]"
                        >
                            <svg
                                stroke="currentColor"
                                fill="currentColor"
