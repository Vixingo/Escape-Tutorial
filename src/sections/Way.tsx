...
const Way = () => {
    return (
        <section className="Way py-20">
            <h1 className="primary_header text-4xl md:text-6xl text-center mb-2">
                We’re with you the whole way
            </h1>{" "}
            <br />
            <p className="text-center px-2 text-xl md:text-3xl max-w-4xl mx-auto py-10">
            ...
            <p className="text-center px-2 text-xl md:text-3xl max-w-4xl mx-auto ">
            ...
            <div>
                ...
                <br />
                <p className="text-center px-2 text-xl md:text-3xl max-w-3xl mx-auto pb-12">
            ...
            <div className="pt-20 px-2">
                <h1 className="primary_header text-4xl md:text-6xl text-center mt-20 py-3">
                    We’re coming soon
                </h1>
                <h3 className="text-center max-w-md mx-auto px-3 text-xl md:text-3xl py-6">
